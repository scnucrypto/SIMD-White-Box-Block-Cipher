// #ifndef WBSM4_SE_CL_NEON_H
// #define WBSM4_SE_CL_NEON_H
...
//     int wbsm4_se_cl_neon_gen_table(wbsm4_se_cl_neon_context *ctx, const uint8_t *key);

//     int wbsm4_se_cl_neon_encrypt(const unsigned char input[256], unsigned char output[256], wbsm4_se_cl_neon_context *ctx);
